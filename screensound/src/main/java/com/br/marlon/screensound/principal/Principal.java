package com.br.marlon.screensound.principal;

import com.br.marlon.screensound.model.Artista;
import com.br.marlon.screensound.model.Musica;
import com.br.marlon.screensound.model.TipoArtista;
import com.br.marlon.screensound.repository.ArtistaRepository;
import com.br.marlon.screensound.service.ConsultaHuggingFace;
...
public class Principal {
    ...
    private void pesquisarDadosDoArtista() {
        System.out.println("Sobre Qual Artista Gostaria de pesquisar? ");
        var nome = leitura.nextLine();
        var resposta = ConsultaHuggingFace.obterInformacao(nome);
    ...
    private void cadastrarArtistas() {
        ...
        while (cadastrarNovo.equalsIgnoreCase("s")) {
            System.out.println("Informe o nome dessse artista: ");
            var nome = leitura.nextLine();
